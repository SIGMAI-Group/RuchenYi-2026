...
################################################
Reference:
    https://github.com/georgeguo-cn/HMCRec
    AAAI'2024: [HMCRec: Local and Global Graph Learning for Multimodal Recommendation]
"""
...
class HMCRec(GeneralRecommender):
    def __init__(self, config, dataset):
        super(HMCRec, self).__init__(config, dataset)
